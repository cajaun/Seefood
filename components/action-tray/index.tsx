...
const ActionTray = forwardRef<ActionTrayRef, ActionTrayProps>(
  ({ style, onClose, contentMap, step, footer }, ref) => {
        ...
        <GestureDetector gesture={gesture}>
          ...
          >
            <Animated.View style={styles.content}>
              <Animated.View
                key={contentKey}
                entering={FadeIn.duration(MIN_DURATION).easing(contentEasing)}
                exiting={FadeOut.duration(MIN_DURATION).easing(contentEasing)}
              >
                {content}
              </Animated.View>
            </Animated.View>
